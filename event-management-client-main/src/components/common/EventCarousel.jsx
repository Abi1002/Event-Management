...
const EventCarousel = () => {
	const [events, setEvents] = useState([{ id: "", eventType: "", eventPrice: "", photo: "" }])
	...
	if (isLoading) {
		return <div className="mt-5">Loading Event....</div>
	}
	if (errorMessage) {
									...
									<Col key={event.id} className="mb-4" xs={12} md={6} lg={3}>
										<Card>
											...
											<Card.Body>
												...
												<Card.Title className="room-price">${event.eventPrice}/night</Card.Title>
